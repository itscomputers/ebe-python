...
def test_from_components(a):
    assert type(a.from_components(a.real, a.imag)) is QuadraticInteger
...
@given(quadratic_integer(nonzero=True), st.integers(min_value=1))
